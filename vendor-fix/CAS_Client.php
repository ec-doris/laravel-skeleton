...
class CAS_Client
{
    ...
    {
        if(isset($_SERVER['HTTP_X_FORWARDED_HOST'])) phpCAS::trace('HTTP_X_FORWARDED_HOST: '.$_SERVER['HTTP_X_FORWARDED_HOST']);
        if(isset($_SERVER['HTTP_X_FORWARDED_SERVER'])) phpCAS::trace('HTTP_X_FORWARDED_SERVER: '.$_SERVER['HTTP_X_FORWARDED_SERVER'] ?? 'N/A');
        if(isset($_SERVER['HTTP_X_FORWARDED_PROTO'])) phpCAS::trace('HTTP_X_FORWARDED_PROTO: '.$_SERVER['HTTP_X_FORWARDED_PROTO'] ?? 'N/A');
        ...
        phpCAS::trace('server_url: '.$server_url);

        if (!strpos($server_url, ':')) {
            if(isset($_SERVER['HTTP_X_FORWARDED_PORT'])) phpCAS::trace('HTTP_X_FORWARDED_PORT: '.$_SERVER['HTTP_X_FORWARDED_PORT'] ?? 'N/A');
            ...
            if (($this->_isHttps() && $server_port!=443)
                ...
                // This cause issues with the load balancer and EU Login
                // $server_url .= ':';
